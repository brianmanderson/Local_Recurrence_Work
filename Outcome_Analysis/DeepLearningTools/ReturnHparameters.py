...
from Deep_Learning.Base_Deeplearning_Code.Finding_Optimization_Parameters.HyperParameters import return_hparams,\
    return_pandas_df, OrderedDict
...
def return_list_of_models(model_type=0):
    ...
    if model_type == 0:
        ...
        dictionary = [
            base_dict0(min_lr=1e-4, max_lr=3e-2, step_factor=40),
