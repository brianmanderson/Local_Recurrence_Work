        ...
        for primary, secondary, case_num in zip(MRN_dictionary[MRN_key]['Primary'],
            ...
            if within.shape[0] != 0:
                ...
                if os.path.exists(os.path.join(nifti_export_path, '{}_Primary_Mask.nii'.format(patient_id)))\
                        or os.path.exists(os.path.join(nifti_export_path, 'Train',
                                                       '{}_Primary_Mask.nii'.format(patient_id)))\
                        or os.path.exists(os.path.join(nifti_export_path, 'Validation',
                                                       '{}_Primary_Mask.nii'.format(patient_id))):
            ...
            secondary_reader = DicomReaderWriter(Contour_Names=['Liver_BMA_Program_4'],
